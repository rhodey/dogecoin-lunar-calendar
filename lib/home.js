  ...
  return html`
    <div class="app">
      <div class="homeBox">
        ...
        <div class="cframe">
          <iframe class="desktopFrame" src="/example.pdf" width="80%" height="650px"></iframe>
          <iframe class="mobileFrame" src="https://docs.google.com/viewer?url=https://dogecoincalendar.com/example.pdf&embedded=true" width="80%" height="650px"></iframe>
        </div>
      </div>
    </div>
  `
